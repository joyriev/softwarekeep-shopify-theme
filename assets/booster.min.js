...
// Cart drawer upsell slick slider js
function slickCarousel() {
  $('.slide-upsell').slick({
    infinite: true,
    slidesToShow: 1,
    slidesToScroll: 1,
     prevArrow:"<button type='button' class='slick-prev pull-left' aria-label='Left Arrow'><i class='uil uil-arrow-circle-left'></i></button>",
     nextArrow:"<button type='button' class='slick-next pull-right' aria-label='Right Arrow'><i class='uil uil-arrow-circle-right'></i></button>",
     responsive: [
     {
      breakpoint: 480,
      settings: {
